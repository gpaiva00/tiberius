      ...
      <CardContentContainer>
        <main className="p-4">
          <h4 className="dark:text-darkTextLight">
            Está com dúvidas sobre como usar o Tiberius? Aqui você encontrará algumas informações
            que podem te ajudar.
          </h4>
          {/* lists */}
          <div className="my-4">
            ...
            <ol className="my-2 list-inside list-decimal dark:text-darkTextLight">
              ...
              <li>
                <span className="font-bold">Editar uma lista:</span> para editar uma lista, clique
                no nome dela para entrar na tela de itens. Na parte superior da tela, clique no nome
                da lista para entrar na tela de configurações da lista.
              </li>
              <li>
              ...
              <li>
                <span className="font-bold">Lista "geral":</span> a lista "geral" é a lista padrão
                do Tiberius. Ela não pode ser excluída e não pode ser renomeada. Ela também não pode
                ser movida para outra posição. O objetivo dessa lista é servir como uma lista de
                tarefas não categorizadas, onde você pode criar itens que não se encaixam em nenhuma
                outra lista e que não serão concluídos no dia atual. Ela também pode ser usada como
                um "arquivo", onde os itens de outras listas podem ser movidos para ela caso não
                sejam concluídos no dia atual.
              </li>
            </ol>
          </div>
          {/* items */}
          <div className="my-4">
            ...
            <ol className="my-2 list-inside list-decimal dark:text-darkTextLight">
              ...
              <li>
                <span className="font-bold">Marcar um item como concluído:</span> para marcar um
                item como concluído, clique no checkbox no lado esquerdo do nome do item.
              </li>
              <li>
                <span className="font-bold">Desmarcar um item como concluído:</span> para desmarcar
                um item como concluído, clique no checkbox no lado esquerdo do nome do item.
              </li>
              <li>
                <span className="font-bold">Ordenar itens:</span> para ordenar os itens, basta
                clicar e arrastar o item para a posição desejada.
              </li>
            </ol>
          </div>
          {/* profile */}
          <div className="my-4">
            ...
            <ol className="my-2 list-inside list-decimal dark:text-darkTextLight">
              <li>
                <span className="font-bold">Acessar o perfil:</span> para acessar o perfil, vá para
                a tela de listas e clique no ícone{' '}
                <User
