    ...
    <main className="flex h-screen flex-col bg-light-background dark:bg-dark-background">
      <div className="flex h-screen flex-1 flex-col px-6 md:px-40">
        <header className="flex items-center justify-between py-10">
          <h1 className="text-2xl font-black dark:text-gray-300">Tiberius</h1>
          {user ? (
            <Link
              to={OVERVIEW_ROUTE}
        ...
        <div className="flex flex-1 flex-col items-center gap-4 pb-10 md:justify-center">
          <div className="flex md:grid md:grid-cols-2">
            <div className="flex flex-col gap-4">
              <h1 className="text-5xl font-black dark:text-gray-300 md:text-6xl">
                lista de tarefas simples.
              </h1>
              <h2 className="text-2xl font-semibold text-gray-200 dark:text-gray-300 md:text-3xl">
            ...
            <div className="hidden flex-col items-center justify-end md:flex">
              ...
              <div className="flex w-full items-end">
                <span className="align-bottom text-sm text-gray-200">
