      ...
      <CardContentContainer>
        <main className="p-4">
          <p className="dark:text-darkTextLight">
            ...
            apenas o essencial, sem distrações. No meu dia a dia, gosto de organizar minhas tarefas
            em bullet points ou checklists, e de fato existem muitas opções de apps que fazem isso,
            mas nenhum deles me agradava completamente, pois todos tinham muito mais do que eu
            precisava, e isso me distraía e me deixava ansioso.
            <br />
            <br />
            Para diminuir minha ansiedade de fazer muitas coisas, decidir criar um app que me
            ajudasse a <span className="font-bold">concentrar apenas no presente</span>, ou seja,
            que me ajudasse a focar apenas nas tarefas do dia atual.
          </p>
          {/* why tiberius */}
          <div className="my-4">
            ...
            <p className="my-2 dark:text-darkTextLight">
              ...
              por ser um <span className="font-bold">administrador eficiente</span>, que se
              preocupava com a <span className="font-bold">economia</span> e com a{' '}
              <span className="font-bold">estabilidade do império</span>. Ele também foi um
              imperador que <span className="font-bold">não gostava de aparecer</span>. Ele também
              era <span className="font-bold">muito rigoroso</span> com seus subordinados.
              <br />
              ...
              <span className="font-bold">rigor</span>, <span className="font-bold">discrição</span>{' '}
              e ao <span className="font-bold">minimalismo</span>.
              <br />
              <br />
          ...
          <div className="my-4">
            ...
            <p className="my-2 dark:text-darkTextLight">
              ...
              apaixonado por tecnologia, e gosto de usá-la para facilitar a vida de alguma forma.
              Sou um entusiasta de <span className="font-bold">produtividade pessoal</span>, e gosto
              de estudar sobre o assunto. Gosto de design e de criar coisas simples e minimalistas.
              <br />
              <br />
