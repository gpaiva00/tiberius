          ...
          <div className="my-4">
            ...
            <ol className="list-inside list-decimal dark:text-darkTextLight">
              <li className="my-2">
                ...
                criar listas de tarefas, adicionar itens a essas listas, marcar itens como
                concluídos e excluir itens.
              </li>
              <li className="my-2">
              ...
              <li className="my-2">
                ...
                <span className="font-bold"> proteção</span> do serviço. Nosso princípio neste ponto
                é de quanto menos dados sobre o usuário coletarmos, menos dados sensíveis teremos em
          ...
          <div className="my-4">
            ...
            <ol className="list-inside list-decimal dark:text-darkTextLight">
              ...
              <li className="my-2">
                ...
                encontre informações sensíveis (por exemplo, dados privados de outros usuários,
                dados sensíveis do sistema ou acesso não autorizado), se compromete a reportar este
                caso de forma privada através do email{' '}
                <a
                ...
                . Após o fechamento da falha, o Tiberius se compromete em criar um Postmortem
                público com os detalhes do que aconteceu. Não temos interesse algum em esconder
                estes acontecimentos e queremos compartilhar todos os conhecimentos adquiridos e
                estratégia adotadas, mantendo em mente que iremos proteger ao máximo dados sensíveis
                dos usuários. Falhas que não possuem informações sensíveis e não irão prejudicar
                outros usuários poderão ser livremente reportados no{' '}
                <a
          ...
          <div className="my-4">
            ...
            <ol className="list-inside list-decimal dark:text-darkTextLight">
              <li className="my-2">
                ...
                serão acompanhadas de notificações dentro do próprio Tiberius. Iremos sempre
                destacar com linguajar simples e com total clareza quais alterações foram
                realizadas.
              </li>
            </ol>
          </div>
